  ...
  function openPageSequence(x:number, aboutRef: any, schoolProjectsRef: any, personalProjectsRef: any)
{
  ...
  let ThoughtsCard: Card = {Name: "Thoughts", Tags: ["C++", "Blueprints", "Unreal Engine", "In Progress"], Desc : "Thoughts is a game I have been solo developing for the past year and a half, using Unreal Engine 4/5", Background: ThoughtsBG};
  ...
  useEffect(() => {
    setTimeout(()=> {openPageSequence(launchCase, aboutRef, personalPRef, schoolPRef)}, 100);
    },[]);
  return (
